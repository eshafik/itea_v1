...
class Post(models.Model):
    ...
    post_status = models.CharField(max_length=10,choices=POST_STATUS_CHOICES,default='draft')
    show_to = models.CharField(max_length=10,choices=SHOW_CHOICES,default='member')
